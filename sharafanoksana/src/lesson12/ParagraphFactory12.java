...
public class ParagraphFactory12 {
     ...
     * @param probability
     */
    ParagraphFactory12(List<String> words, int probability) {
    ...
    private void createListParagraph(List<String> words, int probability) {
        for (int i = 0; i < RandomNumberGenerator12.getRandom(1, 20); i++) {
            SentenceFactory12 s = new SentenceFactory12(words, probability);
